...
public class CTHostnameVerifierBuilder(
    ...
    private var logListService: String? = null
    private var logListDataSource: DataSource<String>? = null
     ...
     */
    @Suppress("MemberVisibilityCanBePrivate")
    public fun setLogListService(logListService: String): CTHostnameVerifierBuilder =
        apply {
    ...
    @JvmSynthetic
    @Suppress("unused")
    public fun logListService(init: () -> String) {
     ...
     */
    @Suppress("MemberVisibilityCanBePrivate")
    public fun setLogListDataSource(logListDataSource: DataSource<String>): CTHostnameVerifierBuilder =
        apply {
    ...
    @JvmSynthetic
    @Suppress("unused")
    public fun logListDataSource(init: () -> DataSource<String>) {
