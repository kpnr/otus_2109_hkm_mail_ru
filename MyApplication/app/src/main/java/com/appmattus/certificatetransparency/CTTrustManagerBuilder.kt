...
public class CTTrustManagerBuilder(
     ...
     */
    @Suppress("MemberVisibilityCanBePrivate")
    public fun setLogListService(logListService: String): CTTrustManagerBuilder =
        apply {
     ...
     */
    @Suppress("MemberVisibilityCanBePrivate")
    public fun setLogListDataSource(logListDataSource: DataSource<String>): CTTrustManagerBuilder =
        apply {
