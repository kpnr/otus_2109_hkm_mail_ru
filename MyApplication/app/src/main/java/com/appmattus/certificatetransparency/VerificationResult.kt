...
public sealed interface VerificationResult {
    ...
    public sealed interface Success : VerificationResult {
        ...
        public data class StaleNetwork(
            ...
            val originalLogListResult: String
        ) : Success
         ...
         */
        public data class DisabledStaleLogList(val logListResult: String) : Success {
            /**
             * Returns a string representation of the object.
             */
    ...
    public sealed interface Failure : VerificationResult {
         ...
         */
        public data class LogServersFailed(val logListResult: String) : Failure {
            /**
             * Returns a string representation of the object.
             */
